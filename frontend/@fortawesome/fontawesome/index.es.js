/*!
 * Font Awesome Pro 5.0.6 by @fontawesome - https://fontawesome.com
  ...
  return apiObject({ type: 'counter', content: content }, function () {
    ...
    return makeLayersCounterAbstract({
      ...
      extra: {
        attributes: attributes,
        styles: styles,
        classes: [config$1.familyPrefix + '-layers-counter'].concat(toConsumableArray(classes))
      }
    });
  });
};
...
export { config, icon, noAuto, toHtml, layer, text, counter, library, dom, parse, findIconDefinition };
